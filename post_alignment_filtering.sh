...
function display_help {
        ...
        echo ""
        echo "Script to send post-alignement filtering job to a HPC. The operation includes: indexing, removing secondary and"
        echo "supplementary alignments, as well as alignments with a MAPQ value lower than 20, collating, fixing mate information,"
        echo "sorting, and removing duplicates. Tools used: samtools, picard MarkDuplicates."
        echo ""
